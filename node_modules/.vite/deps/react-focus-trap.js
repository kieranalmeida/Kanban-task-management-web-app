...
//#region node_modules/react-focus-trap/index.js
var require_react_focus_trap = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	*/
	...
	var defaultProps$1 = { element: "div" };
	var FocalPoint = function(superclass) {
		...
		FocalPoint.prototype.focus = function focus() {
			if (this.contains(document.activeElement) === false) this.root.focus();
		};
		...
		FocalPoint.prototype.returnFocus = function returnFocus() {
			if (this.anchor && typeof this.anchor === "object" && typeof this.anchor.focus === "function") this.anchor.focus();
		};
		FocalPoint.prototype.componentWillMount = function componentWillMount() {
			if (isDOM) this.anchor = document.activeElement;
		};
	...
	var FocusTrap = function(superclass) {
		...
		FocusTrap.prototype.render = function render() {
			...
			return React.createElement("div", {
				...
				onClick: onExit
			}), React.createElement(FocalPoint, {
				className,
				element
			}, children));
		};
...
//#endregion
export default require_react_focus_trap();
